...
$insert=@'
    # P31: frozen P30 SAFE + modern Thetis VFO/BAND/MODE/STEP + container Lock/No Title Bar.
...
$new="'METERS_GADGETS=THETIS_DIRECT_P30_PLUS_MODERN_GADGETS','P31_BASE=P30_SAFE_5fb179f357771f2c6aebcfdd7f13136d8c5f1e72','P31_GADGETS=VFO_DISPLAY,BAND_BUTTONS,MODE_BUTTONS,TUNESTEP_BUTTONS','P31_CONTAINER_CONTROLS=LOCK,NO_TITLE_BAR','P31_NO_TITLE_BAR_SHIFT_ACCESS=ENABLED','THETIS_METER_PERSISTENCE=REPLACE_ALL','THETIS_METER_SKINS=OFFICIAL_DEFAULT_METERS_ALL_IMAGES','THETIS_TX_TELEMETRY=POWERSDR_NATIVE_DTTSP_THREAD1_AND_FLEX5000_PA_FIELDS','RX2_METER=NOT_EXPOSED','FLEXMETERS_HELPER_DLL=ABSENT','THETIS_BACKEND=ABSENT','THETIS_NETWORKIO=ABSENT','THETIS_CHANNELMASTER=ABSENT','THETIS_WDSP=ABSENT',"
