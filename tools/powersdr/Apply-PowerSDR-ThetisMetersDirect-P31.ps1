...
$meterEnumNew=@'
        CROSS,
        // modern Thetis gadgets backported in P31
        VFO_DISPLAY,
        BAND_BUTTONS,
        MODE_BUTTONS,
        TUNESTEP_BUTTONS,
        ...
        LAST
'@
if(!$mm.Contains($meterEnumOld)){throw 'P31 MeterType enum anchor missing'}
$mm=$mm.Replace($meterEnumOld,$meterEnumNew)
...
$itemEnumNew=@'
                ...
                ITEM_GROUP
'@
if(!$mm.Contains($itemEnumOld)){throw 'P31 MeterItemType enum anchor missing'}
$mm=$mm.Replace($itemEnumOld,$itemEnumNew)
