...
$insert=@'
    ...
    # P49: full database read/write audit and persistence hardening.
    & (Join-Path $PSScriptRoot 'Apply-PowerSDR-DatabasePersistence-P49.ps1') -SourceRoot $WorkRoot
