...
try{
    ...
    # P24 native Thetis meter renderer dependencies are isolated to this worktree.
    & (Join-Path $PSScriptRoot 'Prepare-PowerSDR-ThetisMetersNative-P24-Dependencies.ps1') -SourceRoot $WorkRoot
    ...
    # P24 native port: original Thetis MeterManager/ucMeter/frmMeterDisplay renderer.
    # Protect the FLEX-5000 hardware/audio/DSP sources byte-for-byte.
    ...
    & (Join-Path $PSScriptRoot 'Apply-PowerSDR-ThetisMetersNative-P24.ps1') -SourceRoot $WorkRoot
...
"@
    ...
    try{
        ...
        $name='PowerSDR-SQ4KOU-FLEX5000-KE9NS-v2.8.0.336-P24-NATIVE-THETIS-METERS-DIAG.x86.msi'
