...
$new="'METERS_GADGETS=THETIS_DIRECT_2023_02_26','THETIS_METER_SOURCE_SHA=8220ec089451380054e9c31313d4ac2d4bf11776','THETIS_METER_RENDERER=SHARPDX_NATIVE','THETIS_METER_PERSISTENCE=REPLACE_ALL','THETIS_METER_SKINS=OFFICIAL_DEFAULT_METERS_ALL_IMAGES','THETIS_METER_SKIN_SOURCE=ramdor/ThetisSkins@601018a9486359b3bdb661063f4687b4c75ad917','THETIS_METER_DARK_SKINS=ananMM-dark,ananMM-bg-tx-dark,cross-needle-dark','THETIS_METER_CONFIG=THETIS_MULTIMETERS2_2023_02_26_DIRECT_CONTROLS','THETIS_TX_TELEMETRY=POWERSDR_DTTSP_THREAD1_FLEX5000_FWC','THETIS_TX_SUPPORTED=MIC,MIC_PK,EQ,EQ_PK,LEVELER,LEVELER_PK,LVL_G,ALC,ALC_PK,ALC_G,COMP,COMP_PK,PWR,REVERSE_PWR,SWR,VOLTS','THETIS_TX_NATIVE_UNAVAILABLE=CFC,CFC_GAIN,ALC_GROUP,AMPS','THETIS_POWER_SCALE=FLEX5000_100W','RX1_METER=UNCHANGED_FROM_P29','RX2_METER=NOT_EXPOSED','FLEXMETERS_HELPER_DLL=ABSENT','THETIS_BACKEND=ABSENT','THETIS_NETWORKIO=ABSENT','THETIS_CHANNELMASTER=ABSENT','THETIS_WDSP=ABSENT',"
