...
try{
    ...
    & (Join-Path $PSScriptRoot 'Apply-PowerSDR-SQ4KOUSplash-P21-FINAL.ps1') -SourceRoot $WorkRoot
    & (Join-Path $PSScriptRoot 'Verify-PowerSDR-SQ4KOUSplash-P21-FINAL.ps1') -SourceRoot $WorkRoot
...
"@
    ...
    try{
        ...
        $name='PowerSDR-SQ4KOU-FLEX5000-KE9NS-v2.8.0.336-P21-FINAL-SQ4KOU-SPLASH.x86.msi'
