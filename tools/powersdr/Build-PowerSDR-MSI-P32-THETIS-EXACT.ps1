...
$insert=@'
    ...
    # P44: native PowerSDR TCI WebSocket control/status server (no audio/IQ yet).
...
$new="'METERS_GADGETS=THETIS_DIRECT_EXACT_ADAPTER','P32_BASE=P30_SAFE','P32_THETIS_SOURCE_SHA=a53b19274e715182d8f386bfabbb2c4164287a0e','P32_SOURCE_OF_TRUTH=THETIS_ONLY','P32_SOURCE_COHERENCE=METER_MANAGER_UCMETER_DISPLAY_SAME_COMMIT','P32_CONTAINER=THETIS_NATIVE_21_FIELD_MODEL','P32_INPUT=THETIS_NATIVE_MOUSE_PIPELINE','P32_METER_TYPES=FULL_A53B192_GENERATION','P32_RENDERER=THETIS_EXACT','P32_ADAPTER=POWERSDR_NATIVE_API_ONLY','P32_RX2=NOT_EXPOSED','P39_LEGACY_ITEMS=STAGE1_VISIBILITY_ONLY','P39_CONTROLS=METERS_BAND_MODE_FILTER_VFOA_VFOB_VFOSYNC','P39_PERSISTENCE=POWERSDR_DB_SQ4KOU_LEGACYITEMS','P39_SPECTRUM_GEOMETRY=UNCHANGED','P44_TCI=CORE_CONTROL_WEBSOCKET','P44_TCI_PROTOCOL=EXPERTSDR3_2_0_COMPAT','P44_TCI_PORT_DEFAULT=50001','P44_TCI_BIND_DEFAULT=0.0.0.0','P44_TCI_RX=RX1_VFOA_VFOB','P44_TCI_RX2=NOT_EXPOSED','P44_TCI_AUDIO_IQ=DEFERRED','THETIS_BACKEND=ABSENT','THETIS_NETWORKIO=ABSENT','THETIS_CHANNELMASTER=ABSENT','THETIS_WDSP=ABSENT',"
