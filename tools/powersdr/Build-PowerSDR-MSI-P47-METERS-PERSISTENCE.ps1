...
$insert=@'
    ...
    # P47: comprehensive Meters/Gadgets persistence audit/fix.
    & (Join-Path $PSScriptRoot 'Apply-PowerSDR-MetersPersistence-P47.ps1') -SourceRoot $WorkRoot
