...
try{
    ...
    & (Join-Path $PSScriptRoot 'Apply-PowerSDR-MinimalSplash-P19.ps1') -SourceRoot $WorkRoot
    & (Join-Path $PSScriptRoot 'Verify-PowerSDR-MinimalSplash-P19.ps1') -SourceRoot $WorkRoot
...
"@
    ...
    try{
        ...
        $name='PowerSDR-SQ4KOU-FLEX5000-KE9NS-v2.8.0.336-P19-SCREEN-BEFORE-AUDIO.x86.msi'
