...
"@
    ...
    try{
        ...
        $name='PowerSDR-SQ4KOU-FLEX5000-KE9NS-v2.8.0.336-P08-DISPLAY-FLUIDITY.x86.msi'
    ...
    @(
      ...
      'WINDOW_STATE_PATCH=SQ4KOU_MAXIMIZED_RESTOREBOUNDS_P02_PREHIDE_CAPTURE_P07','SHUTDOWN_PATCH=SQ4KOU_GLOBAL_JOIN_BUDGET_REMOVE_REDUNDANT_SLEEPS_P03','AUDIO_EXIT_PATCH=SQ4KOU_TERMINAL_PA_ABORTSTREAM_P04','POWER_OFF_ORDER_PATCH=SQ4KOU_AUDIO_BEFORE_FWC_STANDBY_P05','SHUTDOWN_EVIDENCE=SQ4KOU_PHASE_AND_DB_TIMING_P06','STATE_SAVE_PATCH=SQ4KOU_INDEXED_SAVEVARS_P07','DISPLAY_PERF_PATCH=SQ4KOU_POINT_REUSE_NORMAL_PRIORITY_DEADLINE_PACING_WATERFALL_MEMMOVE_P08','DTTSP_RUNTIME=KE9NS_2.8.0.329_RELEASE_BINARY','DTTSP_SOURCE_336_NOT_BUILT=TRUE',
