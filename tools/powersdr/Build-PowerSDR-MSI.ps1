...
try{
    ...
    # P22: minimal native Thetis container + one FLEX-5000 RX1 telemetry adapter.
    # Physical radio/log validation is intentionally NOT claimed by CI.
    & (Join-Path $PSScriptRoot 'Apply-PowerSDR-ThetisMeterStage1-P22.ps1') -SourceRoot $WorkRoot
    & (Join-Path $PSScriptRoot 'Verify-PowerSDR-ThetisMeterStage1-P22.ps1') -SourceRoot $WorkRoot
...
"@
    ...
    try{
        ...
        $name='PowerSDR-SQ4KOU-FLEX5000-KE9NS-v2.8.0.336-P22-THETIS-RX1-STAGE1.x86.msi'
